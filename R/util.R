.message <- function(action) {
  ...
  } else if (action == "getAphiaRecordByID") {
    return("<soapenv:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:aph=\"http://aphia/v1.0/AphiaRecord\"><soapenv:Header/><soapenv:Body><aph:getAphiaRecordByID soapenv:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\"><AphiaID xsi:type=\"xsd:int\">?</AphiaID></aph:getAphiaRecordByID></soapenv:Body></soapenv:Envelope>")
  }
}
